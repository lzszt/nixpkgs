{
  ...
  deface = {
    dependencies = ["actionview" "nokogiri" "polyglot" "railties" "rainbow"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "01iqxxm7zncr6z8vjd2zfy24v2szx73ynka76gna9vqq6vd7gnmn";
      type = "gem";
    };
    version = "1.9.0";
  };
  ...
  mini_portile2 = {
    groups = ["common_mark" "default" "development" "test"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
  ...
  redmine_plugin_kit = {
    dependencies = ["deface" "rails"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1n8zjjyfvgsdjh57gdh97xgrfxxl9r4dzf8bj295gpvdqavya3zd";
      type = "gem";
    };
    version = "1.0.6";
  };
  ...
  slim-rails = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "15hwzbzihn126k1mhw2imkgp0hzh4qxianrrwgknxg41faqd6zb3";
      type = "gem";
    };
    version = "3.7.0";
  };
  ...
  svg_sprite = {
    dependencies = ["nokogiri" "svg_optimizer" "thor"];
    groups = ["development"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
